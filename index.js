...
var pickInputs = {
    ...
    pickOutputs = {
        ...
        'temp_high_normal': 'almanac.temp_high.normal.C',
        'temp_high_record': 'almanac.temp_high.record.C',
        'temp_high_recordyear': 'almanac.temp_high.recordyear',
        'temp_low_normal': 'almanac.temp_low.normal.C',
        'temp_low_record': 'almanac.temp_low.record.C',
